...
# ╔═╡ efd97896-f3fe-11ec-0c34-ef60860601b7
...
@everywhere begin #ALTER THIS DICTIONARY TO DEFINE PARAMETER DISTRIBUTIONS
	...
	mdata = [
		...
		#(:mean_sharing, last),
		#(:median_sharing, last),
		#(:mean_cluster_size, last),
		#(:median_cluster_size, last),
	]
